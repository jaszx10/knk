...
$pages = @(
    @{
        file = "sport.html"
        title = "TVS Sport - KNK TVS"
        slogan = "Mileage Ka Baap"
        h1 = "TVS SPORT"
        desc = "The TVS Sport is the ultimate daily commuter motorcycle, balancing outstanding fuel efficiency, robust performance, and everyday comfort."
        model = "TVS Sport"
        js = "sport-details.js"
    }
)
